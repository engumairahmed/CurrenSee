//This file contains API Endpoints hosted on 000webhost and stored locally too, use endpoints accordingly if 000webhost is not available

// ------> Login URL

// String loginurl="https://currensee.000webhostapp.com/auth/login.php";
String loginurl = "http://localhost/currensee/auth/login.php";

// ------> Register URL

// String registerurl="https://currensee.000webhostapp.com/auth/register.php";
String registerurl = "http://localhost/currensee/auth/register.php";

// ------> User Password Update URL

// String userPasswordUpdateurl = "https://currensee.000webhostapp.com/auth/changepassword.php";
String userPasswordUpdateurl = "http://localhost/currensee/auth/changepassword.php";

// ------> User Profile URL

// String userDataUrl="https://currensee.000webhostapp.com/auth/user.php?id=";
String userDataUrl = "http://localhost/currensee/auth/user.php?id=";

// ------> Firbase Profile UID verification URL

// String uidCheckUrl="https://currensee.000webhostapp.com/auth/uid.php?id=";
String uidCheckUrl = "http://localhost/currensee/auth/uid.php?id=";

// ------> Conversion URL

// String conversionUrl="https://currensee.000webhostapp.com/conversion/convert.php";
String conversionUrl = "http://localhost/currensee/conversion/convert.php";
...
String feedbackurl = "http://localhost/currensee/feedback.php";

// ------> Get Feedback Data URL

String feedbackDataURL = "http://localhost/currensee/getfeedback.php?id=";

// ------> Historical Rates URL

// String historicalRatesURL="https://currensee.000webhostapp.com/conversion/historical.php";
String historicalRatesURL = "http://localhost/currensee/conversion/historical.php";

// ------> Get Currency Codes URL

String currencyCodesURL="https://currensee.000webhostapp.com/conversion/getcurrencycodes.php";
// String currencyCodesURL = "http://localhost/currensee/conversion/getcurrencycodes.php";
...
String conversionHistoryURL = "http://localhost/currensee/conversion/conversionhistory.php?id=";


// ------> User Preferences URL

String userPreferencesURL = "http://localhost/currensee/userpreferences.php";
...
String getPreferencesURL = "http://localhost/currensee/getuserpreferences.php?id=";
